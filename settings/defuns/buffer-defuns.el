...
(defun comint-delchar-or-eof-or-kill-buffer (arg)
  "Kill shell buffer if process is dead."
  (interactive "p")
...
(defun split-window-vertically-with-other-buffer ()
  "Split window vertically and load an other buffer."
  (interactive)
  (split-window-below)
...
(defun split-window-horizontally-with-other-buffer ()
  "Split window horizontally and load an other buffer."
  (interactive)
  (split-window-right)
  (set-window-buffer (next-window) (other-buffer))
  (windmove-right))
