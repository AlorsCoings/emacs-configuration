...
;;; Commentary:
;;; Emacs configuration file for rgrep
...
(defun rgrep-goto-file-and-close-rgrep ()
  "In rgrep goto file and close rgrep."
  (interactive)
  (compile-goto-error)
  (kill-buffer "*grep*")
  (delete-other-windows)
...
(defun git-grep-fullscreen (regexp &optional files dir confirm)
  "Open git grep in full screen, saving windows."
  (interactive
...
(defun mc/add-cursors-to-all-matches ()
  "Multiple-cursor Add cursors to all match."
  (interactive)
